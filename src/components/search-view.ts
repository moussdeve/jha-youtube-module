...
import { SortOptions, ViewMode } from "../types.js";
...
export class SearchView extends LitElement {
  ...
  private searchController = new SearchController(this, 'API_KEY_HERE');
  ...
  private handleSortChange(e: Event) {
    ...
    this.searchController.setSortBy(select.value as SortOptions);
  }
