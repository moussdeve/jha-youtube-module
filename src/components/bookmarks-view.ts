...
export class BookmarksView extends LitElement {
  ...
  connectedCallback() {
    ...
    this.storage?.addEventListener('bookmarks-changed', this.handleStorageChange as EventListener);
  ...
  disconnectedCallback() {
    ...
    this.storage?.removeEventListener('bookmarks-changed', this.handleStorageChange as EventListener);
  }
  ...
  private handleToggleBookmark(e: CustomEvent) {
